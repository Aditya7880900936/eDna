...
import { 
  Upload, FileText, Database, Search, Download, Filter, 
  AlertCircle, CheckCircle, Clock, Microscope, X, ChevronRight,
  BarChart3, MapPin, Layers, ChevronDown, ChevronUp, User, Settings,
  HelpCircle, Bell, Plus, MoreVertical, ExternalLink, Sparkles
} from 'lucide-react';
...
const Dashboard: React.FC = () => {
  ...
  const speciesData: SpeciesData[] = [
    { id: '1', name: 'Bathymodiolus thermophilus', confidence: 0.95, depth: 2200, location: 'Hydrothermal Vent Site A', taxa: 'Mollusca', abundance: 125, status: 'common' },
    { id: '2', name: 'Calyptogena magnifica', confidence: 0.89, depth: 2100, location: 'Cold Seep Site B', taxa: 'Mollusca', abundance: 87, status: 'rare' },
    { id: '3', name: 'Riftia pachyptila', confidence: 0.92, depth: 2300, location: 'Hydrothermal Vent Site C', taxa: 'Annelida', abundance: 210, status: 'common' },
    { id: '4', name: 'Alvinella pompejana', confidence: 0.87, depth: 2400, location: 'Hydrothermal Vent Site A', taxa: 'Annelida', abundance: 76, status: 'endangered' },
    { id: '5', name: 'Pyrococcus furiosus', confidence: 0.94, depth: 2150, location: 'Deep Sea Plain', taxa: 'Archaea', abundance: 342, status: 'common' },
    { id: '6', name: 'Desulfovibrio profundus', confidence: 0.91, depth: 2250, location: 'Sediment Core D', taxa: 'Bacteria', abundance: 198, status: 'common' },
    { id: '7', name: 'Shewanella piezotolerans', confidence: 0.83, depth: 2350, location: 'Hydrothermal Vent Site C', taxa: 'Bacteria', abundance: 112, status: 'rare' }
  ];

  const unknownTaxa: UnknownTaxa[] = [
    { id: 'UNK_001', sequence: 'ATCGATCGATCGATCGATCGATCG...', similarity: 0.76, closestMatch: 'Bathymodiolus sp.', length: 2456, gcContent: 0.42 },
    { id: 'UNK_002', sequence: 'GCTAGCTAGCTAGCTAGCTAGCTA...', similarity: 0.68, closestMatch: 'Deep-sea bacteria sp.', length: 1872, gcContent: 0.38 },
    { id: 'UNK_003', sequence: 'TTACGGTACCAATTACGGTACCAA...', similarity: 0.72, closestMatch: 'Marine archaeon', length: 3124, gcContent: 0.56 }
  ];

  const processStages: ProcessStage[] = [
    { name: 'Data Upload', description: 'Validating and preparing sequence data', icon: Upload, progress: 100 },
    { name: 'Quality Control', description: 'Filtering low-quality sequences', icon: Filter, progress: 100 },
    { name: 'Feature Extraction', description: 'Identifying genetic markers', icon: Database, progress: 100 },
    { name: 'Autoencoder Analysis', description: 'Pattern recognition and clustering', icon: Layers, progress: 80 },
    { name: 'CNN Classification', description: 'Species prediction and confidence scoring', icon: Microscope, progress: 60 },
    { name: 'Results Compilation', description: 'Generating final report', icon: FileText, progress: 30 }
  ];
  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    if (selectedFiles.length === 0) {
      setSelectedFiles([
        { name: 'deep_sea_samples.csv', size: '124MB', sequences: 450, date: new Date().toLocaleDateString() }
      ]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-3">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">eDNA Biodiversity Classifier</h1>
                <p className="text-xs text-gray-500">Deep-Sea Marine Species Identification</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200/70 p-6">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-semibold text-gray-900">Upload eDNA Sequences</h2>
                <button 
              ...
              {showHelp && (
                <div className="bg-blue-50 rounded-lg p-4 mb-6">
                  ...
                  <ul className="text-sm text-blue-800 list-disc pl-5 space-y-1">
                    <li>CSV format with sequence ID and nucleotide data columns</li>
                    <li>Maximum file size: 500MB</li>
                    <li>Optional metadata: depth, location, collection date</li>
                    <li>Accepted formats: FASTA, FASTQ (will be converted automatically)</li>
                  </ul>
                </div>
              )}
              ...
              <div 
                className={`border-2 border-dashed rounded-xl p-8 text-center transition-colors ${
                  isDragging ? 'border-blue-400 bg-blue-50/50' : 'border-blue-300 bg-blue-50/30'
                }`}
              ...
              >
                ...
                <p className="text-sm text-gray-500 mb-6">Supports CSV, FASTA, and FASTQ files up to 500MB</p>
                ...
                <p className="text-xs text-gray-400 mt-4">By uploading, you agree to our data processing terms</p>
              </div>
                      ...
                      <div key={index} className="flex items-center justify-between bg-gray-50 rounded-lg p-3">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500">{file.size} • {file.sequences} sequences</p>
                          </div>
                        </div>
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-5 rounded-lg border border-blue-200/50">
                  ...
                  <h3 className="font-medium text-gray-900 mb-1">Format Requirements</h3>
                  <p className="text-sm text-gray-600">CSV with sequence ID and nucleotide data columns</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 p-5 rounded-lg border border-green-200/50">
                  ...
                  <h3 className="font-medium text-gray-900 mb-1">Metadata Support</h3>
                  <p className="text-sm text-gray-600">Include depth, location, and collection information</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-5 rounded-lg border border-purple-200/50">
                  ...
                  <h3 className="font-medium text-gray-900 mb-1">AI Classification</h3>
                  <p className="text-sm text-gray-600">Advanced autoencoder + CNN species prediction</p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200/70 p-6">
              ...
              <div className="mb-8 bg-gray-100 rounded-full h-2">
                <div 
                  ...
                  style={{ width: `${(processingStage / (processStages.length - 1)) * 100}%` }}
                ></div>
              </div>
                ...
                {processStages.map((stage, index) => {
                  ...
                  return (
                    <div key={index} className={`flex items-start p-4 rounded-xl border transition-all ${
                      ...
                      isComplete ? 'bg-green-50/50 border-green-200' : 'bg-gray-50/50 border-gray-200'
                    }`}>
                      <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center mr-4 ${
                        isActive ? 'bg-blue-100 text-blue-600' : 
                        isComplete ? 'bg-green-100 text-green-600' : 'bg-gray-200 text-gray-500'
                      }`}>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700">
                        Successfully classified 450 sequences • Identified 135 known species • Detected 25 unknown taxa
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200/70 p-5">
                <h3 className="text-sm font-medium text-gray-700 mb-2">File Processed</h3>
                <p className="text-2xl font-semibold text-gray-900">deep_sea_samples.csv</p>
              </div>
              
              <div className="bg-white rounded-xl shadow-sm border border-gray-200/70 p-5">
                <h3 className="text-sm font-medium text-gray-700 mb-2">Sequences Analyzed</h3>
                <p className="text-2xl font-semibold text-gray-900">450</p>
              </div>
              
              <div className="bg-white rounded-xl shadow-sm border border-gray-200/70 p-5">
                <h3 className="text-sm font-medium text-gray-700 mb-2">Estimated Completion</h3>
        ...
        {activeTab === 'results' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200/70 p-5">
                <h3 className="text-sm font-medium text-gray-700 mb-2">Total Species</h3>
                <p className="text-2xl font-semibold text-gray-900">135</p>
              </div>
              
              <div className="bg-white rounded-xl shadow-sm border border-gray-200/70 p-5">
                <h3 className="text-sm font-medium text-gray-700 mb-2">Average Confidence</h3>
                <p className="text-2xl font-semibold text-gray-900">89.2%</p>
              </div>
              
              <div className="bg-white rounded-xl shadow-sm border border-gray-200/70 p-5">
                <h3 className="text-sm font-medium text-gray-700 mb-2">Taxonomic Groups</h3>
                <p className="text-2xl font-semibold text-gray-900">12</p>
              </div>
              
              <div className="bg-white rounded-xl shadow-sm border border-gray-200/70 p-5">
                <h3 className="text-sm font-medium text-gray-700 mb-2">Rare Species</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200/70 overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h3 className="text-lg font-semibold text-gray-900">Classified Species</h3>
                <span className="text-sm text-gray-500">{filteredSpecies.length} results</span>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Abundance</th>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredSpecies.map((species) => (
                      <tr key={species.id} className="hover:bg-gray-50/50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(species.status)}`}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium text-gray-900">{(species.confidence * 100).toFixed(1)}%</span>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">{species.abundance}</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">{species.depth}m</div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center text-sm text-gray-500">
                ...
                {filteredSpecies.length === 0 && (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500">No species match your search criteria</p>
                  </div>
                )}
              </div>
            </div>
        ...
        {activeTab === 'unknown' && (
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200/70 p-6">
              <div className="flex justify-between items-center mb-6">
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">Unknown Taxa</h2>
                  <p className="text-sm text-gray-500 mt-1">Sequences that couldn't be classified with high confidence</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {unknownTaxa.map((taxa) => (
                  <div key={taxa.id} className="border border-gray-200 rounded-xl p-4 hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        <h3 className="font-medium text-gray-900">{taxa.id}</h3>
                        <p className="text-xs text-gray-500 font-mono truncate max-w-[180px]">{taxa.sequence}</p>
                      </div>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{(taxa.similarity * 100).toFixed(1)}%</span>
                      </div>
                      
                      <div className="flex justify-between">
                        <span className="text-gray-600">Closest match:</span>
                        <span className="font-medium text-right">{taxa.closestMatch}</span>
                      </div>
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{(taxa.gcContent * 100).toFixed(1)}%</span>
                      </div>
                    </div>
              ...
              <div className="mt-6 bg-orange-50 border border-orange-200 rounded-xl p-4">
                <div className="flex">
                  ...
                  <div>
                    <h3 className="font-medium text-orange-800">Next Steps for Unknown Taxa</h3>
                    <p className="text-sm text-orange-700 mt-1">
                      These sequences may represent novel species or variants. Consider submitting to genomic databases 
                      for further analysis and comparison with global datasets.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {activeTab === 'analytics' && (
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200/70 p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Analysis Overview</h2>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-slate-50 to-blue-50/30 rounded-xl p-5 border border-gray-200/50">
                  <h3 className="font-medium text-gray-700 mb-4">Taxonomic Distribution</h3>
                  <div className="h-48 flex items-center justify-center border border-dashed border-gray-300 rounded-lg">
                    <p className="text-gray-400">Taxa distribution chart will appear here</p>
                  </div>
                </div>
                
                <div className="bg-gradient-to-br from-slate-50 to-green-50/30 rounded-xl p-5 border border-gray-200/50">
                  <h3 className="font-medium text-gray-700 mb-4">Confidence Distribution</h3>
                  <div className="h-48 flex items-center justify-center border border-dashed border-gray-300 rounded-lg">
                    <p className="text-gray-400">Confidence histogram will appear here</p>
                  </div>
                </div>
              </div>
              
              <div className="mt-6 bg-gradient-to-br from-slate-50 to-purple-50/30 rounded-xl p-5 border border-gray-200/50">
                <h3 className="font-medium text-gray-700 mb-4">Depth vs. Species Distribution</h3>
                <div className="h-64 flex items-center justify-center border border-dashed border-gray-300 rounded-lg">
                  <p className="text-gray-400">Depth distribution chart will appear here</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 mt-8 border-t border-gray-200/70">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500">© 2023 eDNA Biodiversity Classifier • CMLRE Marine Research Portal</p>
